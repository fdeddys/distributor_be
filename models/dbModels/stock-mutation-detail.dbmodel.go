...
// StockMutationDetail ...
type StockMutationDetail struct {
	ID           int64     `json:"id" gorm:"column:id"`
	MutationID   int64     `json:"mutationId" gorm:"column:mutation_id"`
...
// TableName ...
func (o *StockMutationDetail) TableName() string {
	return "public.mutation_detail"
}
