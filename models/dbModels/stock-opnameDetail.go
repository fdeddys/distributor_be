...
type StockOpnameDetail struct {
	...
	StockOpnameID int64     `json:"stockOpnameId" gorm:"column:stock_opname_id"`
	...
	QtyOnSystem   int64     `json:"qtyOnSystem" gorm:"column:qty_on_system"`
...
func (o *StockOpnameDetail) TableName() string {
	return "public.stock_opname_detail"
}
