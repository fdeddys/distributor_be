...
// ReturnReceiveDetail ...
type ReturnReceiveDetail struct {
	ID              int64 `json:"id" gorm:"column:id"`
	ReturnReceiveID int64 `json:"returnReceiveId" gorm:"column:return_receive_id"`
...
// TableName ...
func (o *ReturnReceiveDetail) TableName() string {
	return "public.return_receive_detail"
}
